...
For packages before v1.0.0:
- Breaking changes bump **minor** version (0.1.0 -> 0.2.0)
- Use `deprecate_soft()` for new deprecations
- Can move faster through deprecation stages
- Mark experimental features with `lifecycle::badge("experimental")`

## Related Skills

- **r-package-workflow** - 9-step workflow uses lifecycle in Step 3
- **cran-submission** - CRAN checks lifecycle badge presence
- **quality-gates** - API stability assessed in quality scoring
