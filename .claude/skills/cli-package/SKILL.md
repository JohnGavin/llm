...
- **adversarial-qa** - Uses `cli_abort()` patterns in error testing
- **tidyverse-style** - Mandates `cli` for package messaging
- **r-package-workflow** - Error handling conventions
