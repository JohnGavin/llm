# Gemini CLI Workflows and Patterns

## CLI Syntax and Basic Usage
...
## Common R Package Analysis Tasks
...
## Using ellmer R Package for Reproducible Analysis
...
### 4. Use Gemini for Understanding, Claude for Action
