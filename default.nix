# This file was generated by the {rix} R package v0.17.2 on 2026-02-08
# with following call:
# >rix(date = latest,
#  > r_pkgs = r_pkgs,
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-01-19.tar.gz") { config.allowUnfree = true; };
