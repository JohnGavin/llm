# This file was generated by the {rix} R package v0.18.1 on 2026-07-01
# with following call:
# >rix(date = latest,
#  > r_pkgs = r_pkgs,
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2026-02-02.tar.gz") { config.allowUnfree = true; };
  ...
  shell = pkgs.mkShell {
    ...
    #<- buildInputs = [ mori roxy.shinylive btw debrief rpkgs system_packages ];
    buildInputs = [ mori roxy.shinylive btw debrief ] ++ rpkgs ++ system_packages;
    shellHook = ''
